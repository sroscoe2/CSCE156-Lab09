...
public class SortingTests {
    ...
    void insertionSortTest() {
        ...
        assertArrayEquals(sortedExpectation, SortingAlgorithms.insertionSort(sortedExpectation));
    }
    ...
    void quickSortTest() {
        ...
        assertArrayEquals(sortedExpectation, SortingAlgorithms.quickSort(sortedExpectation));
    }
